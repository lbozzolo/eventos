...
class DietaCatogenicaController extends AppBaseController
{
    private $repo;
    private $gender;
    private $model;
    ...
    public function __construct(RecetaRepository $repository)
    {
        ...
        $this->gender = 'F';
        $this->model = 'dieta Catogenica';
        $this->modelPlural = 'dietas Catogenicas';
        $this->modelSpanish = 'dieta Catogénica';
