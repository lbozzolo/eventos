...
(function (factory) {
  ...
  var dom = (function () {
     ...
     * - [workaround] old IE only proyectos with &nbsp;
     * - [workaround] IE11 and other browser proyectos with bogus br
     */
  ...
  */
  ...
  var Editor = function (context) {
    ...
    this.initialize = function () {
      ...
      // [workaround] IE doesn't have input proyectos for contentEditable
   ...
   *  mouse proyectos that show/hide popover will be handled by Handle.js.
   *  Handle.js will receive the proyectos and invoke 'imagePopover.update'.
   */
