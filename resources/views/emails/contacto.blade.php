        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-12 col-sm-12" style="margin-bottom: 50px">
                    <img src="http://eventum.com.ar/images/logos/logo_eventum_chico.png" />
                </div>
                ...
                <div class="col-lg-9 col-xs-12 col-sm-12">
                    <div class="blog-item">
                        ...
                        <div class="blog__content">
                            ...
                            <h1 class="">Contacto vía email de eventum.com.ar</h1>
                            <div class="blog__meta d-flex align-items-center">

                                <div class="blog__meta-cat">
                                    <span style="color: #149EA6">{!! $data['name'] !!}</span>
                                </div>
                            ...
                            <small>Empresa: {!! $data['company'] !!}</small><br>
                            <small>Tel: {!! $data['phone'] !!}</small>
                            <hr>
