...
<ul class="list-inline" id="list-images" style="border: 2px dotted lightgrey; padding: 5px">
    @forelse($receta->images as $imagen)
...
<div class="">
    <div class="box-body">
        ...
        <span id="producto-id" data-producto-id="{!! route('subir.imagen', ['id' => $receta->id, 'class' => 'Receta']) !!}"></span>
        ...
        <div id="croppie-image" style="display: none; padding: 20px">
            <div class="col-lg-10 col-lg-offset-1">
                <div class="lead text-center">
                    ...
                    <a href="{{ route('productos.edit', $receta->id) }}" class="btn btn-default mt-3">Cancelar</a>
                </div>
