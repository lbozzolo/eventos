...
@section('content')
    ...
    @if(\Carbon\Carbon::now()->addHours(2)->format('Y-m-d H:i') >= $charla->fecha_formatted_view)
        ...
        @if(\Carbon\Carbon::now()->format('Y-m-d H:i') < $charla->fecha_completa->addHours($charla->addHours)->format('Y-m-d H:i'))
            ...
            <section class="pb-40 pt-2" style="background-image: url('{!! asset('images/fondo_antesala.webp') !!}')">
                <div class="pl-2 pr-2">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-body" style="margin-top: 0px; padding-top: 0px">
                                <div class="container">
                                    <div class="row heading heading-2 mb-40"></div>
                                    <div class="row">

                                        @foreach($charla->iframes as $iframe)

                                        <div class="col-sm-12 col-md-6
                                             @if($charla->iframes->count() == 2) col-lg-6
                                             @elseif($charla->iframes->count() == 3) col-lg-4
                                             @elseif($charla->iframes->count() == 4) col-lg-3
                                             @else col-lg-4 @endif">

                                            <div class="service-item">
                                                <div class="service__content">
                                                    <h4 class="service__title">{!! $iframe->title !!}</h4>

                                                    <a href="{!! route('web.charlas.ingresar.sala',
                                                        ['cliente' => $charla->cliente_slug, 'evento' => $charla->nombre_slug, 'id' => $charla->id, 'sala' => $iframe->id]) !!}"
                                                        class="btn btn__secondary btn__link">
                                                        <span style="color: #97B128">Acceder acá</span>
